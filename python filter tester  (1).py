...
def main():
    ...
    def gen_ctx(cdigits):
        ...
        return {
            ...
            'prev_seed_digits': prev_digits,       # Draw 2-back
            ...
            'mirror': MIRROR,
            'common_to_both': set(seed_digits) & set(prev_digits),  # common to Draw 1- and 2-back
            'last2': set(seed_digits) | set(prev_digits),          # union of Draw 1- and 2-back
            'Counter': Counter
        }
    ...
    # Static initial filter count display
