...
def main():
    ...
    # Toggle to hide zero-elimination filters initially
    ...
    # Display according to hide_zero toggle
    if hide_zero:
        display_filters = [flt for flt in sorted_filters if flt_counts[flt['id']] > 0]
    else:
